 ...
 * <tt>BZip2OutputStream</tt> to release the allocated memory.
 * </p>
 * <p>
...
public class BZip2OutputStream extends OutputStream
     ...
     */
    public BZip2OutputStream(final OutputStream out, final boolean omitHeader)
            throws IOException {
        this(out, MAX_BLOCKSIZE, omitHeader);
    }
    ...
    public BZip2OutputStream(final OutputStream out,
                             final int blockSize, final boolean omitHeader)
            throws IOException {
        super();
     ...
     */
    private void init(boolean omitHeader) throws IOException {
        if (!omitHeader) {
            bsPutUByte('B');
            bsPutUByte('Z');
        }
