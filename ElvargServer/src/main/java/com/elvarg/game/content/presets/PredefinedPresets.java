...
public class PredefinedPresets {
    ...
    public static final Presetable MAIN_TRIBRID_126 = new Presetable("Bot Tribrid",
            new Item[]{
                    ...
                    new Item(WATER_RUNE, 1000), new Item(BLOOD_RUNE, 1000), new Item(DEATH_RUNE, 1000), new Item(TELEPORT_TO_HOUSE, 1),
            },
            new Item[]{
                    new Item(HELM_OF_NEITIZNOT),
                    ...
                    new Item(CLIMBING_BOOTS),
                    new Item(RING_OF_RECOIL),
                    new Item(DRAGONSTONE_DRAGON_BOLTS_E_, 75),
            },
            /* atk, def, str, hp, range, pray, mage */
            new int[]{99, 99, 99, 99, 99, 99, 99},
            MagicSpellbook.ANCIENT,
